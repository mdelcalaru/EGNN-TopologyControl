...
folder_name=f"run_{timestamp}_T{task_agents}N{comm_agents}"
filename = f"{folder_name}/{num_experiments}Runs_dist{int(10*distance_coeficient)}_"
...
while experiment < num_experiments:
    ...
    G = to_networkx(data_ini, to_undirected=True)
    ...
    if nx.is_connected(G): 
        ...
        print('Initial configuration not connected')
