...
from mid.funciones_auxiliares import evalModelConvex
from mid.connectivity_optimization import ConnectivityOpt
from mid.utils import plot_config
import math
from mid.nacho import Simulation
import pickle as pk

num_experiments=1
filename= f"datos_plots_paper/Scenario3/{num_experiments}Run_"
...
for experiment in range(num_experiments):
    ...
    try:
        ...
        try:
            R_nacho, _, C_nacho, aik_nacho, _=evalModelConvex(NA=xNA_fin_nacho, TA=TA.numpy(), channel=canal, Kopts=Kopts)
        except:
